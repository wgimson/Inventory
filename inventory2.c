 ...
 *            pointer to the node containing the part number; if the part    *
 ...
 *         the part already exists or space could not be allocated for the   *
 *         part.                                                             *
 *****************************************************************************/
void insert(void)
{
    ...
    for (curr = inventory, prev = NULL; curr != NULL && 
            new_node->number > curr->number; prev = curr, curr = curr->next) {
        ;
    }
