...
/*****************************************************************************
 * main: Prompts the user to enter and operation code, then calls a function *
 *       to perform the requested action. Repeats until the user enters the  *
 *       command 'q'. Prints an error message if the user enter an illegal   *
 *       code.                                                               *
 *****************************************************************************/
int main(void)
{ 
 ...
 *         inserts the part into the database. Prints an error message and   *
 *         returns prematurely if the part already exists or the database is *
 *         full.                                                             *
 *****************************************************************************/
void insert(void)
{
